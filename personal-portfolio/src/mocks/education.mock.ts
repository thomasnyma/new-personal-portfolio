...
export const mockEducation: JobInfo[] = [
	{
		...
		description:
			"My academic background is in data and communication with a specialization in programming. I studied at TEC in Ballerup, where I gained a solid foundation of theoretical and practical knowledge.<br /><br />However, I chose to leave the program before graduating to pursue more hands-on work experience in the field. I believe that learning by doing is the best way to improve my skills as a programmer, and I'm eager to take on new challenges and opportunities in my career.",
	},
	{
		id: 'atu',
